...
class ModelEngine:
    ...
    def validate_and_create(model_class: type[Model], data: dict) -> Model:
        ...
        errors: list[ZoeSchemaException] = [
            *ModelEngine.__validate_model_types(hints=hints, data=data),
            *ModelEngine.__run_validators(class_dict=model_class.__dict__, data=data)
            ]
    ...
    @staticmethod
    def __run_validators(class_dict: dict[str, type], data: dict) -> list[ZoeSchemaException]:
        errors: list[ZoeSchemaException] = []
